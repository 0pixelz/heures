...
(() => {
  ...
  function summary(){
    ...
    const regular = Math.min(worked, REGULAR_PAY_LIMIT);
    const overtime = Math.max(0, worked - REGULAR_PAY_LIMIT);
    return { start,end,worked,regular,overtime,threshold:REGULAR_PAY_LIMIT };
  }
