(() => {
  ...
  function ask(d){ if(!d.start)return 'Quelle est ton heure de début?'; if(d.meal==null)return 'Combien de minutes de repas as-tu pris?'; if(!d.end)return 'Quelle est ton heure de fin?'; return null; }
